...
public class PacketReceiver implements Runnable 
{
   ...
   public PacketReceiver( MessageListener listener ) 
   {
      ...
      try // conecta o MulticastSocket ao endere�o de multicast e � porta
      {
   ...
   {          
      ...
      while ( keepListening ) 
      {
         ...
         message = message.trim(); // apara o espa�o em branco na mensagem

         // separa a mensagem em tokens para recuperar o nome do usu�rio e corpo da mensagem
