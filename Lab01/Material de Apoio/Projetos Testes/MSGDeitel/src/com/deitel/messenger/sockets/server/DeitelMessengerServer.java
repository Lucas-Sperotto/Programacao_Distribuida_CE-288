...
// DeitelMessengerServer � um servidor de bate-papo com m�ltiplas threads, baseado em socket e em
// pacotes.
...
public class DeitelMessengerServer implements MessageListener
{
   ...
   public void startServer() 
   {
      ...
      try // cria o servidor e gerencia novos clientes
      {
         ...
         while ( true ) 
         {
            ...
            // imprime informa��es sobre a conex�o
   ...
   } // fim do m�todo startServer
   
   // quando nova mensagem � recebida, transmite a mensagem para os clientes
   public void messageReceived( String from, String message ) 
   {          
      // cria String que cont�m uma mensagem inteira
